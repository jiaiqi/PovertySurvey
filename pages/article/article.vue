<template>
	<view class="article-wrap">
		...
		<view class="create-time" v-if="articleData.create_time">{{ articleData.create_time }}</view>
		<view class="content" v-if="articleData.content"><view class="" v-html="articleData.content"></view></view>
		<view class="content" v-if="articleData.introduce"><view class="" v-html="articleData.introduce"></view></view>
