            ...
            if (!formula[operator].val) {
              ...
              if (_valueObj.value_key && _valueObj.value_type) {
                switch (_valueObj.value_type) {
                  case 'rowData':
                    result = rowData[evaluator(formula[operator]['col'], result)] != rowData[_valueObj.value_key];
                    break;
                  case 'login_user_info':
                  case 'top.user':
                    var _login_user_info = uni.getStorageSync('login_user_info');
                    if (_login_user_info && typeof _login_user_info === 'object') {
                      result = rowData[evaluator(formula[operator]['col'], result)] != _login_user_info[_valueObj.value_key];
                    } else {
                      result = false;
                    }
                    break;
...
/***/ 11:
/*!***********************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/store/index.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!***************************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/store/mutations.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters */ 14));var _mutations;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var mutations = (_mutations = {
  sysViewCfg: function sysViewCfg(state, data) {
    state.sysViewCfg = data;
  },
  showHeader: function showHeader(state) {
    state.headShow = true;
  },
  hideHeader: function hideHeader(state) {
    state.headShow = false;
  },
  showFooter: function showFooter(state) {
    state.footerShow = true;
  },
  hideFooter: function hideFooter(state) {
  ...
  showMenus: function showMenus(state) {
    state.showMenus = true;
  },
  hideMenus: function hideMenus(state) {
    state.showMenus = false;
  },
  showLeftBack: function showLeftBack(state) {
    state.showLeftBack = true;
  },
  hideLeftBack: function hideLeftBack(state) {
    state.showLeftBack = false;
  },
  setLogined: function setLogined(state, loginInfo) {
  ...
  setLoginMsg: function setLoginMsg(state, loginMsg) {
  ...
  selectByUser: function selectByUser(state, datas) {
    state.parentMenu = datas.amount;
  },
  setHeadrBar: function setHeadrBar(state, list) {
    state.headrBar = list.data;
  },
  setAuthorState: function setAuthorState(state, data) {
    state.AuthorState = data;
  },
  setIsWeixinCient: function setIsWeixinCient(state, data) {
    console.log('当前微信状态' + data);
    state.isWeixinCient = data;
  },
  setSrvCol: function setSrvCol(state, data) {
    state.srvCol.push(data);
  },
  delSrvCol: function delSrvCol(state, data) {
    var fils = state.srvCol.filter(function (item) {return item.service_name !== data;});
    state.srvCol = fils;
  },
  setShowSearch: function setShowSearch(state, data) {
  ...
  } }, _defineProperty(_mutations, "setAuthorState", function setAuthorState(
state, author_state) {
  state.author_state = author_state;
}), _defineProperty(_mutations, "setUserType", function setUserType(
state, user_type) {
  state.user_type = user_type;
}), _defineProperty(_mutations, "setClientType", function setClientType(
state, client_type) {
  state.client_type = client_type;
}), _defineProperty(_mutations, "setClientEnv", function setClientEnv(
state, client_env) {
...
/***/ 14:
/*!*************************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/store/getters.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _getSysViewCfg$header;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // 创建可以获取状态信息的方法
var _default = (_getSysViewCfg$header = {
  getSysViewCfg: function getSysViewCfg(state) {
    return state.sysViewCfg;
  },
  headerShow: function headerShow(state) {
  ...
  getLoginMsg: function getLoginMsg(state) {
  ...
  getHeadrBar: function getHeadrBar(state) {
    if (state.headrBar) {
  ...
  getIsWeixinCient: function getIsWeixinCient(state) {
  ...
  getSrvCol: function getSrvCol(state) {
    return state.srvCol;
  },
  getShowSearch: function getShowSearch(state) {
    return state.showSearch;
  },
  getAppInfo: function getAppInfo(state) {
  ...
  } }, _defineProperty(_getSysViewCfg$header, "getAuthorState", function getAuthorState(
state) {
  return state.author_state;
}), _defineProperty(_getSysViewCfg$header, "getUserType", function getUserType(
state, user_type) {
  return state.user_type;
}), _defineProperty(_getSysViewCfg$header, "getClientType", function getClientType(
state, client_type) {
  return state.client_type;
}), _defineProperty(_getSysViewCfg$header, "getClientEnv", function getClientEnv(
state, client_env) {
  return state.client_env;
}), _getSysViewCfg$header);exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 创建驱动actions可以使方法启动
var _default = {
  setSysViewCfg: function setSysViewCfg(_ref, payload) {var commit = _ref.commit;
    commit('sysViewCfg', payload.data);
  },
  showHeader: function showHeader(_ref2) {var commit = _ref2.commit;
    commit('showHeader');
  },
  hideHeader: function hideHeader(_ref3) {var commit = _ref3.commit;
    commit('hideHeader');
  },
  showFooter: function showFooter(_ref4) {var commit = _ref4.commit;
    commit('showFooter');
  },
  hideFooter: function hideFooter(_ref5) {var commit = _ref5.commit;
    commit('hideFooter');
  },
  showLoading: function showLoading(_ref6) {var commit = _ref6.commit;
    commit('showLoading');
  },
  hideLoading: function hideLoading(_ref7) {var commit = _ref7.commit;
    commit('hideLoading');
  },
  showMenus: function showMenus(_ref8) {var commit = _ref8.commit;
    commit('showMenus');
  },
  hideMenus: function hideMenus(_ref9) {var commit = _ref9.commit;
    commit('hideMenus');
  },
  showLeftBack: function showLeftBack(_ref10) {var commit = _ref10.commit;
    commit('showLeftBack');
  },
  hideLeftBack: function hideLeftBack(_ref11) {var commit = _ref11.commit;
    commit('hideLeftBack');
  },
  logined: function logined(_ref12, payload) {var commit = _ref12.commit;
    commit('logined', payload);
  },
  setLogined: function setLogined(_ref13, payload) {var commit = _ref13.commit;
    commit('setLogined', payload);
  },
  selectByUser: function selectByUser(_ref14, payload) {var commit = _ref14.commit;
    commit('selectByUser', payload);
  },
  setHeadrBar: function setHeadrBar(_ref15, payload) {var commit = _ref15.commit;
    commit('setHeadrBar', payload);
  },
  setLoginMsg: function setLoginMsg(_ref16, payload) {var commit = _ref16.commit;
    commit('setLoginMsg', payload);
  },
  setAuthorState: function setAuthorState(_ref17, payload) {var commit = _ref17.commit;
    commit('setAuthorState', payload);
  },
  setIsWeixinCient: function setIsWeixinCient(_ref18, payload) {var commit = _ref18.commit;
    commit('setIsWeixinCient', payload);
  },
  setSrvCol: function setSrvCol(_ref19, payload) {var commit = _ref19.commit;
    commit('setSrvCol', payload);
  },
  setShowSearch: function setShowSearch(_ref20, payload) {var commit = _ref20.commit;
    commit('setShowSearch', payload.amount);
  },
  setOpenId: function setOpenId(_ref21, payload) {var commit = _ref21.commit;
...
/***/ 21:
/*!***********************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/common/util.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(n);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default = {
  install: function install(Vue, options) {
    ...
    Vue.prototype.urlParamsFilter = function (e) {
      var reqUrlParams = this.$api.reqUrlParams;
      var params = [];
      var filter = this.$api.reqUrlParamsFilter;
      var isFilter = false; // false  不添加参数
      var url = e;
      var appfilters = [];
      var srvfilters = [];
      if (e !== undefined) {
        if (reqUrlParams.length > 0 && url.indexOf("select") !== -1) {
          // 是否存在自定义参数
          params = reqUrlParams.map(function (item) {
          ...
          if (filter.app.length > 0) {
            ...
            for (var key in filter.app) {
              var filterStr = "/" + filter.app[key] + "/";
              appfilters.push(filterStr);
            }
          }
          if (filter.filterSrv.length > 0) {
            // 需要过滤的 srv 
            for (var _key in filter.filterSrv) {
              var _filterStr = filter.filterSrv[_key];
              srvfilters.push(_filterStr);
            }
          }
          if (appfilters.length > 0) {
            ...
            var arr = [];
            var sarr = [];
            for (var _key2 in appfilters) {
              if (url.indexOf(appfilters[_key2]) !== -1) {
                // 无需添加参数
                arr.push(true);
              }
            }
            if (srvfilters.length > 0) {
              // 有需要过滤的srv
              for (var _key3 in srvfilters) {
                if (url.indexOf(srvfilters[_key3]) !== -1) {
                  // 无需添加参数
                  sarr.push(true);
                }
              }
          ...
          if (isFilter) {
            ...
            if (params.length > 0) {
              for (var _key4 in params) {
                if (url.indexOf("?") !== -1) {
                  url = url + "&" + params[_key4].colName + "=" + params[_key4].value;
                } else {
                  url = url + "?" + params[_key4].colName + "=" + params[_key4].value;
                }
              }
    ...
    /**
        ...
        * @param {String} app 
        */
    Vue.prototype.getServiceV2 = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(srv, srvType, pageType, app) {var self, appName, len, serviceName, cols, nCols, req, condObj, url, response, pageconfig;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0: // 表单信息 srvType : add | update | list | detail | select
                // use_type: detail | proclist | list | treelist | detaillist | selectlist | addchildlist | updatechildlist | procdetaillist | add | update
                self = this;
                appName = app || uni.getStorageSync("activeApp");if (!(
                srv && srvType && pageType)) {_context.next = 43;break;}
                len = srv.lastIndexOf('_');
                serviceName = srv.slice(0, len) + '_';
                if (srvType === 'list' || srvType === 'detail') {
                  serviceName += 'select';
                ...
                nCols = cols.filter(function (item) {return item.service_name === serviceName && item.use_type === pageType;});
                console.log('=====1', nCols);if (!(
                nCols.length === 0)) {_context.next = 39;break;}
                req = this.selectRequestObjs();
                req.serviceName = 'srvsys_service_columnex_v2_select';
                req.colNames = ['*'];
                req.condition = [];
                ...
                url = Vue.prototype.getServiceUrl(appName, "srvsys_service_columnex_v2_select", "select", url);
                url = url + "?colsel_v2=" + serviceName;_context.next = 30;return (
                  this.$http.post(url, req));case 30:response = _context.sent;if (!
                response.data.data) {_context.next = 37;break;}
                console.log('=====2', response.data.data);
                response.data.data.use_type = pageType;
                if ('rowButton' in response.data.data) {
                ...
                // 第一次拿到，缓存
                pageconfig = Vue.prototype.getPageConfig(response.data.data, pageType);
                // self.$store.commit('setSrvCol', pageconfig)
                return _context.abrupt("return", pageconfig);case 37:_context.next = 41;break;case 39:


                console.log('=====3', nCols);return _context.abrupt("return",

                nCols[0]);case 41:_context.next = 44;break;case 43:return _context.abrupt("return",


                false);case 44:case "end":return _context.stop();}}}, _callee, this);}));return function (_x, _x2, _x3, _x4) {return _ref.apply(this, arguments);};}();
      ...
      cols = cols.map(function (item, index) {
        ...
        if (item.col_type === "String" || item.col_type === "TelNo" || item.col_type === 'IdNo') {
          ...
          if (item.columns === "identity_image") {
            if (item.more_config) {
              try {
                var settings = JSON.parse(item.more_config);
        ...
        if (item.more_config) {
          var config = JSON.parse(item.more_config);
        ...
        if (item.more_config && typeof item.more_config == "string") {
          try {
            var moreConfig = JSON.parse(item.more_config);
    ...
    Vue.prototype.treeReform = function (e, pidcol, idcol) {
      // 
      var data = Vue.prototype.deepClone(e);
      ...
      var reform = function reform(allData, pd, id, data) {
        // 根据顶级节点组装数有子节点
        var datas = Vue.prototype.deepClone(data); // 当前级别
        var aDatas = Vue.prototype.deepClone(allData); // 剩余data
    ...
    /**
        ...
        * @param {String} app 
        */
    Vue.prototype.onRequest = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(optionType, srv, req, app) {var self, reqType, url;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                self = this;
                reqType = optionType;
                ...
                url = Vue.prototype.getServiceUrl(app || uni.getStorageSync("activeApp"), srv, optionType);return _context2.abrupt("return",
                self.$http.post(url, req));case 5:case "end":return _context2.stop();}}}, _callee2, this);}));return function (_x5, _x6, _x7, _x8) {return _ref2.apply(this, arguments);};}();
    ...
    Vue.prototype.getServiceUrl = function (app, srv, srvType, url) {
      ...
      var singleApp = this.$api.singleApp;

      var urlVal = url || this.$api.srvHost;
      var appVal = app;
      if (singleApp) {
    ...
    Vue.prototype.getValidators = function (vds, msg) {// 获取校验信息返回组件data
      if (vds !== null && msg !== null) {
        var _str = vds;
        console.log('vds', vds);
        var _getStr = function _getStr(val, state, end) {
          if (val.length > state.length + end.length) {
            var s = val.indexOf(state);
            if (s === -1) {
              return '';
        ...
        var Validators = {};
        var reg = /required/gi;
        Validators['max'] = _getStr(_str, 'ngMaxlength=', ';').length > 0 ? parseInt(_getStr(_str, 'ngMaxlength=', ';')) :
        null;
        Validators['min'] = _getStr(_str, 'ngMinlength=', ';').length > 0 ? parseInt(_getStr(_str, 'ngMinlength=', ';')) :
        null;
        Validators['reg'] = _getStr(_str, 'ngPattern=', ';');
        Validators['required'] = reg.test(_str);
        Validators['msg'] = _getStr(msg, 'ngPattern=', ';');
        Validators['isType'] = function (e) {
          var reg = new RegExp(_getStr(_str, 'ngPattern=', ';'));
          if (reg.test(e)) {
            var obj = {
              valid: reg.test(e),
              msg: "有效" };
            ...
            var msgs = _getStr(msg, 'ngPattern=', ';');
            msgs = msgs === '' ? '信息有误' : msgs;
            var _obj = {
              valid: reg.test(e),
              msg: msgs };
        ...
        var _reg = /required/gi;
        var _Validators = {};
        _Validators['required'] = _reg.test(vds);
        return _Validators;
      } else {
        return false;
      }
    ...
    Vue.prototype.formateDate = function (date) {var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'date';
      console.log(date);
      date = new Date(date);
      var o = {
        'yy': date.getFullYear(),
    ...
    // 获取图片路径
    Vue.prototype.getFilePath = /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(e) {var url, req, response;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                ...
                e) {_context3.next = 9;break;}_context3.next = 5;return (
                  this.$http.post(url, req));case 5:response = _context3.sent;
                console.log('srvfile_attachment_select', response);if (!(
                response.data.state === 'SUCCESS' && response.data.data.length > 0)) {_context3.next = 9;break;}return _context3.abrupt("return",
                response.data.data);case 9:case "end":return _context3.stop();}}}, _callee3, this);}));return function (_x9) {return _ref3.apply(this, arguments);};}();
    ...
    Vue.prototype.getWxUserInfo = /*#__PURE__*/function () {var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(userInfo) {var optionType, srv, app, req, res, wxUser;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                //查找微信用户头像昵称
                optionType = 'select';
                ...
                req = {
                  ...
                  condition: [{
                    colName: 'app_no',
                    ruleType: 'eq',
                    value: uni.getStorageSync('_appNo') ? uni.getStorageSync('_appNo') : Vue.prototype.$api.appNo.wxmp }] };_context4.next = 6;return (


                  Vue.prototype.onRequest(optionType, srv, req, app));case 6:res = _context4.sent;
                ...
                if (res.data.state === 'SUCCESS' && res.data.data.length > 0) {
                  ...
                  Vue.prototype.setWxUserInfo(userInfo);
                }case 8:case "end":return _context4.stop();}}}, _callee4);}));return function (_x10) {return _ref4.apply(this, arguments);};}(),

    Vue.prototype.setWxUserInfo = /*#__PURE__*/function () {var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5(e) {var userInfo, url, req, response;return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                userInfo = null;
                ...
                url = Vue.prototype.getServiceUrl('wx', 'srvwx_basic_user_info_save', 'operate');
                req = [{
                  ...
                  "data": [{
                    ...
                    "city": userInfo.city,
                    "headimgurl": userInfo.avatarUrl }] }];if (!


                e) {_context5.next = 14;break;}_context5.next = 9;return (
                  this.$http.post(url, req));case 9:response = _context5.sent;
                console.log('setWxUserInfo', response);if (!(
                response.data.state === 'SUCCESS' && response.data.data && response.data.data.length > 0)) {_context5.next = 14;break;}
                Vue.prototype.wxLogin();return _context5.abrupt("return",
                response.data.data);case 14:case "end":return _context5.stop();}}}, _callee5, this);}));return function (_x11) {return _ref5.apply(this, arguments);};}();
    ...
    Vue.prototype.onButtonRequest = function (e) {
      var btn, row, condition, defaultVal;
              ...
              uni.showModal({
                ...
                success: function success(res) {
                  if (res.confirm) {
                    ...
                    Vue.prototype.onRequest("delete", params.serviceName, req).then(function (res) {
      ...
      if (e && Vue.prototype.iObject(e)) {
        ...
        if (btn.is_public) {
          switch (btn.button_type) {
            ...
            case "delete":
              return new Promise(function (resolve, reject) {
                Vue.prototype.onButtonRequest(e).then(function (res) {
                  if (res) {
                    resolve(res);
                  } else {
                    reject(res);
            ...
            case "detail":
              if (e.hasOwnProperty("row")) {
                ...
                console.log("点击了【有效】的公共编辑按钮", row);
                uni.navigateTo({
                  url: "/pages/formPage/formPage?params=" + JSON.stringify(_params2) });
    ...
    Vue.prototype.verifyLogin = function (code) {
      //验证登录(静默登录)
      var url = Vue.prototype.$api.verifyLogin.url;
      var req = [{
        data: [{
          code: code,
      ...
      Vue.prototype.$http.post(url, req).then(function (response) {
    ...
    Vue.prototype.getBasicsInfo = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6() {var userInfo, url, req, res;return _regenerator.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
              userInfo = uni.getStorageSync('login_user_info');
              url = Vue.prototype.getServiceUrl('zhxq', 'srvzhxq_member_select', 'select');
              req = {
                ...
                page: {
                  pageNo: 1,
                  rownumber: 10 } };_context6.next = 5;return (


                Vue.prototype.$http.post(url, req));case 5:res = _context6.sent;if (!(
              res.data.data.length > 0)) {_context6.next = 9;break;}
              uni.setStorageSync('basics_info', res.data.data[0]);return _context6.abrupt("return",
              res.data.data[0]);case 9:case "end":return _context6.stop();}}}, _callee6);})),
        ...
        success: function success(res) {
          if (res.code) {
            ...
            wx.getSetting({
              success: function success(res) {
                // checkAuthorization
                var isAuthUserInfo = res.authSetting['scope.userInfo'];
                var isAuth = uni.getStorageSync('isAuth');
    ...
    Vue.prototype.selectInfoFromMember = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee7() {var userInfo, wxUserInfo, url, req, res;return _regenerator.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
              console.log('selectInfoFromMember');
              userInfo = uni.getStorageSync('login_user_info');
              wxUserInfo = uni.getStorageSync('wxuserinfo');if (!
              userInfo.openid) {_context7.next = 22;break;}
              url = Vue.prototype.getServiceUrl('zhxq', 'srvzhxq_member_front_select', 'select');
              req = {
                ...
                page: {
                  pageNo: 1,
                  rownumber: 10 } };_context7.next = 8;return (


                Vue.prototype.$http.post(url, req));case 8:res = _context7.sent;if (!(

              res.data.state === 'SUCCESS' && res.data.data.length === 0)) {_context7.next = 14;break;}
              ...
              false);case 14:if (!(
              res.data.state === 'SUCCESS' && res.data.data.length > 0 && res.data.data[0].islock === '是')) {_context7.next = 19;break;}
              uni.showModal({
                title: "提示",
                content: "当前帐号无权限访问",
                showCancel: false,
              ...
              false);case 19:return _context7.abrupt("return",
              true);case 20:_context7.next = 23;break;case 22:return _context7.abrupt("return",

              false);case 23:case "end":return _context7.stop();}}}, _callee7);})),
    ...
    Vue.prototype.html2text = function (str) {
      var strs = "";
      if (!!str) {
...
/***/ 22:
/*!***********************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/common/http.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _wx = _interopRequireDefault(__webpack_require__(/*! @/common/wx.js */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入flyio
...
/***/ 23:
/*!*********************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/common/wx.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*******************************************************************!*\
  !*** D:/user/Documents/HBuilderProjects/PovertySurvey/pages.json ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
